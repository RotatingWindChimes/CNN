...
class FRCNNAnchorMaker(object):
    ...
    def _enumerate_shifted_anchor(self,origin_image_size):
        ...
        # shift的shape为 (width * height,4) ,因为网格中一共有width * height个点，4的维度存储的是每个点的(x坐标、y坐标、x坐标、y坐标)
        ...
        anchor /= divisor
        # 返回的shape为 (width//16 * height//16 * 9,4)
        return anchor
...
if __name__ == '__main__':
    ...
    frcnn_anchor_maker._enumerate_shifted_anchor([600, 1000])